<script lang="ts">
	...
	import ValidarTareaEstadoForm from '$lib/components/admin/administracion/solicitud/validar-tarea-estado-form.svelte';
	import type { PageProps } from '../../../dashboard/$types';
	import ValidarTareaMovimientoViewPdf from '$lib/components/admin/administracion/solicitud/validar-tarea-movimiento-view-pdf.svelte';
