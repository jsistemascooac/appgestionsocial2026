<script lang="ts">
	...
	import DataTable from '$lib/components/admin/administracion/dashboard/data-table.svelte';
	import { columns } from '$lib/components/admin/administracion/dashboard/columns.js';
	import { columns_edit } from '$lib/components/admin/administracion/dashboard/columns_edit.js';
