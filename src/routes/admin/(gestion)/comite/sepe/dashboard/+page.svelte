<script lang="ts">
	...
	import { getWFMovimientoConfiguracion, getWFValidarTareas } from '$lib/api/admin/comite/sepe/dashboard/dashboard.remote.js';
	import DataTable from '$lib/components/admin/comite/sepe/dashboard/data-table.svelte';
	import { columns } from '$lib/components/admin/comite/sepe/dashboard/columns.js';
	import { columns_edit } from '$lib/components/admin/comite/sepe/dashboard/columns_edit.js';
