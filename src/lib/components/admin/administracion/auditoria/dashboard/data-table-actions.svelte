<script lang="ts">
 ...
 import * as DropdownMenu from "$lib/components/ui/dropdown-menu/index.js";
	...
	import { addWFValidarTarea } from "$lib/api/admin/administracion/financial/solicitud/validar.remote";
 ...
 <DropdownMenu.Content >
  <DropdownMenu.Group>
   ...
   <DropdownMenu.Item  onclick={async () => {
      ...
      goto('/admin/administracion/auditoria/solicitud/editar/' + validar.id);
      }else{
        goto('/admin/administracion/auditoria/solicitud/editar/' + id);
      }
		} catch (error) {
